//Admin class,Run this file to add ,delete or modify flights or
//add admin with name and password...
...
public class Client1
{
	...
	//DATA MEMBERS
	static String [] admin = {"CHIRAG","AMIT","RAHUL","a"};
	static String [] pswd = {"IIT2021035","IIT2021054","IIT2021137","a"};
	...
	public static void mainM()
	{
		...
		System.out.print("\u001b[2J");
		System.out.flush();
		System.out.println("WELCOME TO IIIT AIRLINES!!!");
		gr.enter();
		System.out.println("\n");
		System.out.println("SYSTEM FOR ADMINISTRATION OF AIRLINES...");
...
//			logA();
		...
		{	
			admn();
			System.out.println("You're now registered on IIIT Admin System.");
//			logA();
	...
	public static void main(String [] args)
	{
		...
		gr.enter();
		System.out.println("\n");
		System.out.println("SYSTEM FOR ADMINISTRATION OF IIIT...");
		System.out.print("1.Login for Existing Admin\n2.Sign-Up for new Admin\nEnter choice: ");
		int y=sc.nextInt();
		...
		{	
			admn();
			System.out.println("You're now registered on IIIT A Admin System.");
			logA();
