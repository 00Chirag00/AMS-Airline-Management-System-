...
public class Flight
{
	...
	public void init()
	{
		...
		dept.set(Calendar.YEAR,2022);
		dept.set(Calendar.MONTH,11);
		dept.set(Calendar.DAY_OF_MONTH,20);
		arvl.set(Calendar.YEAR,2022);
		arvl.set(Calendar.MONTH,11);
		arvl.set(Calendar.DAY_OF_MONTH,20);
